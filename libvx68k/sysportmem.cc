...
using vx68k::system_ports_memory;
...
system_ports_memory::get_16(function_code fc, uint32_type address) const
{
  ...
  if (!once++)
    fprintf(stderr,
	    "class system_ports_memory: FIXME: `get_16' not implemented\n");
  return 0;
}
...
system_ports_memory::get_8(function_code fc, uint32_type address) const
{
  ...
  if (!once++)
    fprintf(stderr,
	    "class system_ports_memory: FIXME: `get_8' not implemented\n");
  return 0;
}

void
system_ports_memory::put_16(function_code fc, uint32_type address,
			    uint16_type value)
{
#ifdef HAVE_NANA_H
  ...
  if (!once++)
    fprintf(stderr,
	    "class system_ports_memory: FIXME: `put_16' not implemented\n");
}

void
system_ports_memory::put_8(function_code fc, uint32_type address, int value)
{
#ifdef HAVE_NANA_H
  ...
  if (!once++)
    fprintf(stderr,
	    "class system_ports_memory: FIXME: `put_8' not implemented\n");
}
